	    ...
	    <div class="sidebar col-md-3 col-lg-2 p-0">
      	...
      	<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      		<section class="mt-3 mb-3">
				<form:form action="/notices/${noticeForm.noticeNum}/edit" method="post" modelAttribute="noticeForm">
					<div class="mb-3">
					...
					<div class="button-group d-flex justify-content-center gap-2">
			            ...
			            <a href="/notices/${noticeForm.noticeNum}" class="btn btn-outline-dark">뒤로가기</a>
					</div>
				</form:form>
			</section>
      	</main>
