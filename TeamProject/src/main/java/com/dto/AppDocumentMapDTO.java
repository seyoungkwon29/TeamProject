...
@Alias("AppDocumentMapDTO")
public class AppDocumentMapDTO {
	...
	public AppDocumentMapDTO() {
		super();
		// TODO Auto-generated constructor stub
	}


	public AppDocumentMapDTO(int doc_no, int member_num, String member_name, int form_no, String form_name,
	...
	public String toString() {
		return "AppDocumentMapDTO [doc_no=" + doc_no + ", member_num=" + member_num + ", member_name=" + member_name
